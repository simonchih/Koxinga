#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe koxinga.py -W mysetup.py
...
koxinga = Target(
    ...
    script="koxinga.py", # path of the main script

    # Allows to specify the basename of the executable, if different from 'koxinga'
    # dest_base = "koxinga",

    # Icon resources:[(resource_id, path to .ico file), ...]
    # icon_resources=[(1, r"koxinga.ico")]

    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="koxinga", level="asInvoker")).encode("utf-8")),
